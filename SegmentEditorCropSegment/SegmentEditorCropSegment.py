...
class SegmentEditorCropSegment(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "SegmentEditorCropSegment"
    self.parent.categories = ["Segmentation"]
    self.parent.dependencies = ["Segmentations"]
    self.parent.contributors = ["Kyle MacNeil (Med-i Lab, Queen's; SPL, BWH)", "Andras Lasso (PerkLab, Queen's)", "Sara Rolfe (UW, Seattle)"]
...
class SegmentEditorCropSegmentTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_CropSegment1()

  def test_CropSegment1(self):
    """
    ...
    The test can be executed from SelfTests module (test name: SegmentEditorCropSegment)
    """

    self.delayDisplay("Starting test_CropSegment1")
    ...
    segmentEditorWidget.setActiveEffectByName("CropSegment")
    ...
    self.delayDisplay('test_CropSegment1 passed')
