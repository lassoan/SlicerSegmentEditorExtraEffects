...
class SegmentEditorFloodFilling(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "SegmentEditorFloodFilling"
...
class SegmentEditorFloodFillingTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_SegmentEditorFloodFilling1()
