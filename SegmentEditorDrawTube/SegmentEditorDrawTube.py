...
class SegmentEditorDrawTube(ScriptedLoadableModule):
  """Uses ScriptedLoadableModule base class, available at:
  https://github.com/Slicer/Slicer/blob/master/Base/Python/slicer/ScriptedLoadableModule.py
  """
  def __init__(self, parent):
    ScriptedLoadableModule.__init__(self, parent)
    self.parent.title = "SegmentEditorDrawTube"
    self.parent.categories = ["Segmentation"]
    self.parent.dependencies = ["Segmentations"]
    self.parent.contributors = ["Csaba Pinter (PerkLab, Queen's)"]
...
class SegmentEditorDrawTubeTest(ScriptedLoadableModuleTest):
  """
  ...
  def test_DrawTube1(self):
    ...
    self.delayDisplay("Starting test_DrawTube1")
